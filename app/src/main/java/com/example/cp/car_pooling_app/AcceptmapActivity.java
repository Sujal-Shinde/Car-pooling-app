...
public class AcceptmapActivity extends AppCompatActivity implements OnMapReadyCallback {
    GoogleMap googlemap;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_acceptmap);
        ...
        if (supportsEs2) {
            ...
            if (googlemap == null) {
                MapFragment mFrag = (MapFragment) getFragmentManager().findFragmentById(R.id.selmap);
    ...
    public void onMapReady(GoogleMap map) {
     ...
     /*   String latitude = SelectedArea.getLat();
        ...
        double latitude = Double.parseDouble(selacceptreq.getLat());
        double longitude = Double.parseDouble(selacceptreq.getLon());

        googlemap = map;
        /*  String name = SelectedArea.getAreaName();*/
        /*String name = selectedofferdata.getSeloffername();*/
        String name = selacceptreq.getFname();
